...
public class AdapterGroupChat extends RecyclerView.Adapter<AdapterGroupChat.HolderGroupChat> {
    ...
    public void onBindViewHolder(@NonNull HolderGroupChat holder, int position) {
        ...
        if (messageType.equals("text")){
            ...
            try {
                Picasso.get().load(message).placeholder(R.drawable.ic_img).into(holder.messageIv);
            } catch (Exception e) {
                holder.messageIv.setImageResource(R.drawable.ic_img);
            }
        }
    ...
    private void setUserName(ModelGroupChat model, final HolderGroupChat holder) {
        ...
        ref.orderByChild("userID").equalTo(model.getSender())
