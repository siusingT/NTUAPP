...
import com.example.ntumobile.adapters.AdapterGroupChat;
import com.example.ntumobile.models.ModelGroupChat;
...
public class GroupChatActivity extends AppCompatActivity {
    ...
    private void sendImageMessage() {
        ...
        StorageReference storageReference = FirebaseStorage.getInstance("gs://ntu-mobile-9eb73.appspot.com/").getReference(filenamePath);
        //upload image
    ...
    private void loadMyGroupRole() {
        ...
        ref.child(groupId).child("Participants")
                .orderByChild("userID").equalTo(firebaseAuth.getUid())
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        if (myGroupRole.equals("creator") || myGroupRole.equals("admin")) {
            //if admin/creator, show add person option
