...
public class TestRetrieve extends AppCompatActivity {
    ...
    FirebaseRecyclerAdapter<Upload, ImageViewHolder> adapter;
    ...
    private void SendUserToMainActivity() {
        Intent mainIntent = new Intent(TestRetrieve.this, MainActivity.class);
    ...
    private void LoadData() {
        ...
        options = new FirebaseRecyclerOptions.Builder<Upload>().setQuery(DataRef, Upload.class).build();
        adapter = new FirebaseRecyclerAdapter<Upload, ImageViewHolder>(options) {
            @Override
