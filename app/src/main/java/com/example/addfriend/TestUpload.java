...
public class TestUpload extends AppCompatActivity {
    ...
    private void SendUserToTestRetrieveActivity() {
        Intent testRetrieveIntent = new Intent(TestUpload.this, TestRetrieve.class);
                    ...
                    public void onSuccess(Uri uri) {
                        ...
                        DataRef.child(key).setValue(hashMap).addOnSuccessListener(new OnSuccessListener<Void>() {
                            ...
                            public void onSuccess(Void aVoid) {
                                Toast.makeText(TestUpload.this, "Data successfully uploaded", Toast.LENGTH_SHORT).show();
                            }
                        });
                    }
                });
